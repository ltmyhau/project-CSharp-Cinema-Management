...
INSERT INTO Phim (MaPhim, TenPhim, MaPL, DaoDien, QuocGia, ThoiLuong, NgayKhoiChieu, Poster, Trailer, MoTa) VALUES
(dbo.f_AutoMaPhim(), N'không poster', 'P', NULL, NULL, 99, CONVERT(DATETIME, '02/28/2024'),  0x, NULL, NULL)

INSERT INTO Phim (MaPhim, TenPhim, MaPL, DaoDien, QuocGia, ThoiLuong, NgayKhoiChieu, Poster, Trailer, MoTa)
VALUES (dbo.f_AutoMaPhim(), @tenPhim , @maPL , @daoDien , @quocGia , @thoiLuong , @ngayKhoiChieu , @poster , @trailer , @moTa );

UPDATE Phim
SET TenPhim = @tenPhim, MaPL = @maPL, DaoDien = @daoDien, QuocGia = @quocGia, ThoiLuong = @thoiLuong, NgayKhoiChieu = @ngayKhoiChieu, Poster = @poster, Trailer = @trailer, MoTa = @moTa
WHERE MaPhim = 'P009'
...
INSERT INTO TheLoai_Phim (MaPhim, MaTL) VALUES (N'P001', N'TL001')
...
SELECT * FROM TheLoai_Phim
WHERE MaPhim = 'P001'


UPDATE TheLoai_Phim
SET MaTL = N'TL001'
WHERE MaPhim = N'P001' AND MaTL = N'TL002'
