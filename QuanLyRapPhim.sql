...
BEGIN
    ...
    ELSE
		BEGIN
			DECLARE @MaxMaHD INT
			SELECT @MaxMaHD = MAX(RIGHT(MaHD, 3)) FROM HoaDon
			SET @MaHD = 'HD' + RIGHT('000' + CAST(@MaxMaHD + 1 AS VARCHAR(3)), 3)
		END
...
BEGIN
    ...
    ELSE
		BEGIN
			DECLARE @MaxMaVe INT
			SELECT @MaxMaVe = MAX(RIGHT(MaVe, 3)) FROM Ve
			SET @MaVe = 'V' + RIGHT('000' + CAST(@MaxMaVe + 1 AS VARCHAR(3)), 3)
		END
...
('HD001', 'KH001', 'NV001', '2024-04-16 08:30:00'),
('HD002', 'KH002', 'NV002', '2024-04-16 09:45:00'),
('HD003', 'KH003', 'NV003', '2024-04-16 10:15:00');

INSERT INTO Ve(MaVe, MaHD, MaGhe, MaSC) VALUES 
('V001', 'HD001', 'C102', 'SC003'),
('V002', 'HD001', 'C103', 'SC003'),
('V003', 'HD001', 'C105', 'SC003'),
('V004', 'HD001', 'E104', 'SC003'),
